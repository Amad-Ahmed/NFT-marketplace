...
<div id="heading_container">
        ...
        <div class="btn-grp">
        <form method="get" action="{{url('/rankings/filter')}}" >
            ...
            <button id="categories_btn"
                ...
                id="dropdownCenterBtn" data-bs-toggle="dropdown" aria-expanded="false">{{$c}}
            </button>
            ...
            <button id="time_btn" class="btn btn-light btn-secondary dropdown-toggle btn-outline-secondary btn-lg"
                type="button" id="dropdownCenterBtn" data-bs-toggle="dropdown" aria-expanded="false">{{$i}}
                </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownCenterBtn">
            ...
            <button id="chains_btn" class="btn btn-light btn-secondary dropdown-toggle btn-outline-secondary btn-lg"
                type="button" id="dropdownCenterBtn" data-bs-toggle="dropdown" aria-expanded="false">{{$o}}
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownCenterBtn">
    ...
    <div id="ranking-list">
        ...
        <div class="d-flex mb-7">
            <div class="first-col me-auto p-2 text-start">
                ...
                <img class="row-img" src="{{$collection->Image}}">
                <span class="col-heading">{{$collection->Name}}</span>
            </div>
            ...
            <div class="col-heading p-2 text-end">{{$collection->Owners/1000}}K</div>
            <div class="col-heading p-2 text-end">{{$collection->Total/1000}}K</div>
        </div>
        <hr>
        @php $Count++; @endphp
        @endforeach
