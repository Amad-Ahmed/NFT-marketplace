            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    <ul class="navbar-nav  mb-2 mb-lg-0">
                        <form class="container-fluid formSetting" method="POST" action="{{url('/search')}}">
                            @csrf
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu " aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{url('/explore')}}">All NFTs</a></li>
                                <li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active optionsSetting" aria-current="page" href="{{url('/login')}}"><span
                                    class="material-icons">
                                    account_circle
                                </span></a>
                            <a  class="nav-link active optionsSetting account-icon visually-hidden" aria-current="page" href="{{url('/account')}}">
