...
<link rel="stylesheet" type="text/css" href="/css/index.css" />
    ...
    <div class="row landing-row">
        <div class="col" style="margin-top: 55px; margin-left: 30px;">
            ...
            <div class="row">
                <a  class="col landing-btn1" href="{{url('/explore')}}"><div >Explore</div></a>
                <div class="col landing-btn2">Create</div>
                <div class="col-4"></div>
            </div>
        </div>
        <div class="col-1 empty-col"></div>
        <a class="col img-responsive landing-nft" href="/detail/{{$coll->slugName}}">
        <div class="">
            <div class="col">
                <img style="border-radius: 20px 20px 0% 0%;" src="{{substr($coll->Image,0,-5)}}" width="450" height="450">
                <div class="row nft-footer">
                    ...
                    <div class="col nft-text">
                        <span><b>{{$coll->Name}}</b></span><br>
                        <span class="resiSpan">{{$coll->Developer}}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col">
            <img class="NotablePics" src="/images/{{$extras[0]['Image']}}">
        </div>
        <div class="col">
            <img class="NotablePics" src="/images/{{$extras[1]['Image']}}">
        </div>
        <div class="col">
            <img class="NotablePics" src="/images/{{$extras[2]['Image']}}">
        </div>
    </div>
</div>
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-item active">
            <img src="{{$top[5]['Banner']}}"
                style="height: 100%; margin: auto;" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{$top[6]['Banner']}}"
                style="height: 100%; margin: auto;" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{$top[7]['Banner']}}"
                style="height: 100%; margin: auto;" class="d-block w-100" alt="...">
        </div>
    </div>
...
<div class="row" style="margin: 5% auto; width: 80%;">
    <div class="col-sm-3"><img class="img-setup2" src="/images/{{$extras[4]['Image']}}"><br>
        <h4 class="heading1">Set up your wallet</h4>
        <p style="text-align: center;">{{$extras[4]['Description']}}</p>
    </div>
    <div class="col-sm-3"><img class="img-setup2" src="/images/{{$extras[5]['Image']}}"><br>
        <h4 class="heading">Create your collection</h4>
        <p style="text-align: center;">{{$extras[5]['Description']}}</p>
    </div>
    <div class="col-sm-3"><img class="img-setup" src="/images/{{$extras[6]['Image']}}"><br>
        <h4 class="heading2">Add your NFTs</h4>
        <p style="text-align: center;">{{$extras[6]['Description']}}</p>
    </div>
    <div class="col-sm-3"><img class="img-setup2" src="/images/{{$extras[7]['Image']}}"><br>
        <h4 class="heading3">List them for sale</h4>
        <p style="text-align: center;">{{$extras[7]['Description']}}</p>
    </div>
</div>
